<template>
	<section class="lg:mx-desktop rounded-2xl p-8 mt-8 hero">
		<div class="">
			<div class="basis-1/2 pl-20 pt-24 relative">
				...
				<h1
					class="font-serif font-bold px-12 text-left text-white uppercase text-6xl leading-[1.15] relative z-40 animate-slideDown">
				...
				<div class="p-4 text-center ">
					<h1
						class="font-serif font-bold bg-white rounded-sm shadow-lg p-8 w-1/2 justify-center text-left m-8 uppercase text-blue-600 text-5xl leading-[1.15] relative z-40 animate-slideDown">
						Nos Services</h1>
