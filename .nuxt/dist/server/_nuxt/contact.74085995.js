...
import "defu";
import "@vue/shared";
const contact_vue_vue_type_style_index_0_scoped_89c2b111_lang = "";
const _sfc_main = {
  __name: "contact",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_nuxt_link, { to: "/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="" data-v-89c2b111${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(ssrRenderComponent(_component_nuxt_link, { to: "/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_1)} alt="" data-v-89c2b111${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_1,
      ...
      _push(ssrRenderComponent(_component_nuxt_link, { to: "/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_2)} alt="" data-v-89c2b111${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_2,
      ...
      _push(ssrRenderComponent(_component_nuxt_link, { to: "/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_3)} alt="" data-v-89c2b111${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_3,
...
//# sourceMappingURL=contact.74085995.js.map
