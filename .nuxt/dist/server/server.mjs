import { getCurrentInstance, reactive, toRef, isRef, inject, defineComponent, computed, ref, h, resolveComponent, shallowRef, unref, watchEffect, markRaw, provide, Suspense, Transition, useSSRContext, mergeProps, openBlock, createElementBlock, createElementVNode, withCtx, createVNode, createTextVNode, withModifiers, createStaticVNode, defineAsyncComponent, onErrorCaptured, createApp } from "vue";
...
const About_vue_vue_type_style_index_0_scoped_b87799d0_lang = "";
const _sfc_main$3 = {};
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/contact.74085995.js").then((m) => m.default || m)
  },
  {
    name: "entreprise",
    path: "/entreprise",
    ...
    component: () => import("./_nuxt/entreprise.0f249015.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index.15524e01.js").then((m) => m.default || m)
  },
  {
    name: "result",
    path: "/result",
    ...
    component: () => import("./_nuxt/result.79732af1.js").then((m) => m.default || m)
  },
  {
    name: "service",
    path: "/service",
    ...
    component: () => import("./_nuxt/service.1c79a6e4.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.c557882a.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
