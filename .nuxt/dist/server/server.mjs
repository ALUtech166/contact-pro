import { getCurrentInstance, reactive, toRef, isRef, inject, defineComponent, computed, ref, h, resolveComponent, shallowRef, unref, watchEffect, markRaw, provide, Suspense, Transition, useSSRContext, mergeProps, openBlock, createElementBlock, createElementVNode, withCtx, createTextVNode, toDisplayString, createVNode, withModifiers, createStaticVNode, defineAsyncComponent, onErrorCaptured, createApp } from "vue";
...
const About_vue_vue_type_style_index_0_scoped_3cbcbaaf_lang = "";
const _sfc_main$3 = {};
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/contact.2c01164c.js").then((m) => m.default || m)
  },
  {
    name: "entreprise",
    path: "/entreprise",
    ...
    component: () => import("./_nuxt/entreprise.75185e1e.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index.0db3621b.js").then((m) => m.default || m)
  },
  {
    name: "service",
    path: "/service",
    ...
    component: () => import("./_nuxt/service.3543813a.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.026d921e.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
