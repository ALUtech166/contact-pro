<template>
	<div>
		...
		<main class="mb-16">
			<Hero />
			<section class="mt-10 lg:px-desktop lg:mx-desktop bg-[#F3F7F5] rounded-2xl">
				<div class="flex divide-x-2">
					<div class="basis-1/2 flex space-x-10">
						<img src="/about.png" alt="About Icon" class="w-auto h-20" />
						<h1 class="font-bold text-center uppercase text-6xl leading-[1.15] relative z-40 animate-slideDown  text-gray-900">
							Ils Nous Font <br>
							Confiance !
						</h1>
					</div>
